        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "categoria",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="veiculos", to="garagem.categoria"
                    ),
                ),
                (
                    "cor",
                ...
                (
                    "marca",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="veiculos", to="garagem.marca"
                    ),
                ),
                (
                    "modelo",
